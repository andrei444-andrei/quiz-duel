...
К каждому вопросу — короткий любопытный факт (1-2 предложения) про правильный ответ,
который интересно узнать после ответа. Факт должен удивлять или давать контекст.
Вопросы на русском, разной сложности, без повторов и без банальностей.

Верни JSON-объект вида:
{"questions":[
  {"q":"текст вопроса","options":["A","B","C","D"],"correct":0,"fact":"любопытный факт про правильный ответ"},
  ...
]}
